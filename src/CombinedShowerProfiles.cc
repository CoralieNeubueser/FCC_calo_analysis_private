#include "CombinedShowerProfiles.h"
...
CombinedShowerProfiles::CombinedShowerProfiles(double aEnergy):
  m_energy(aEnergy) {
  Initialize_histos();
}

CombinedShowerProfiles::~CombinedShowerProfiles() {}


void CombinedShowerProfiles::Initialize_histos()
{
  ...
  h_longProfile = new TH1F("h_longProfile","", 19, x0_x);
  ...
  h_longProfile_particle = new TH1F("h_longProfile_particle","", 19, x0_x);
  ...
  h_longProfile_particle_hcal = new TH1F("h_longProfile_particle_hcal","", 19, x0_x);
...
void CombinedShowerProfiles::processEvent(podio::EventStore& aStore, int aEventId, bool aVerbose) {
  //Get the collections
...
void CombinedShowerProfiles::finishLoop(int aNumEvents, bool aVerbose) {
