#ifndef CHISQUAREMINIMISATIONBARREL_H
#define CHISQUAREMINIMISATIONBARREL_H
...
class ChiSquareMinimisationBarrel: public MultiFileAnalysis {

 public:
  ChiSquareMinimisationBarrel(double aEnergy, const std::string& aBitfieldEcal, const std::string& aBitfieldHcal);
  ~ChiSquareMinimisationBarrel();
